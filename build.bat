...
REM Set the path to MSBuild. This is typically in your Visual Studio installation directory.
REM Modify the following line with the correct path for your environment.

set MSBUILD_PATH="C:\Program Files\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin\MSBuild.exe"

REM Set the path to the .sln or .vcxproj file
set PROJECT_PATH="C:\actions-runner\_work\_tool\SAST.sln"

REM Set the build configuration (Debug or Release)
set CONFIGURATION=Release

REM Set the target platform (e.g., x86, x64)
set PLATFORM=x64
